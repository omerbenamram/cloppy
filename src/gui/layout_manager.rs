...
impl LayoutManager {
    ...
    pub fn initial(&self, gui: &Gui) {
        gui.input_search()
            .wnd()
            .set_position(INPUT_MARGIN, INPUT_MARGIN, 0, 0, SWP_NOSIZE)
            .unwrap();
        gui.item_list()
            .wnd()
            .set_position(0, FILE_LIST_Y, 0, 0, SWP_NOSIZE)
            .unwrap();
    }
    ...
    pub fn on_size(&self, gui: &Gui, event: Event) {
        ...
        gui.input_search()
            .wnd()
            .set_position(0, 0, width, INPUT_HEIGHT, SWP_NOMOVE)
            .unwrap();
        ...
        gui.item_list()
            ...
            .set_position(
                ...
                0,
                new_width,
                gui.client_wnd_height() - FILE_LIST_Y,
                SWP_NOMOVE,
            )
            .unwrap();
    }
